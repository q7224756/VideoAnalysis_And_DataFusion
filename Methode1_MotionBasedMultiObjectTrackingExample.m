%% changes:
% 1. set costOfNonAssignment = 10; reduce cost of non assignment value from 20 to 10 can reduce the wrong predicted seperate moving objects
% 2. set 'MinimumBlobArea', 1000; let the detector only detect big moving objects.
...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.reader = vision.VideoFileReader(uigetfile('.mp4','Please select video file!'));
...
% indices of tracks and detections that remained unassigned. 
    ...
    function [assignments, unassignedTracks, unassignedDetections] = ...
        ...
        costOfNonAssignment = 10; % reduce cost of non assignment value from 20 to 10 can reduce the wrong predicted seperate moving objects
        [assignments, unassignedTracks, unassignedDetections] = ...
